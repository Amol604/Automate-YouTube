...
public class Wrappers {
    ...
    public static void movetoelementtoclick(WebDriver driver, WebElement locator) {
        try {
    ...
    public static void clickOnRightArrow(WebDriver driver, int i, WebElement rightArrow) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'clickOnRightArrow'");
    }
    public static long extractLikesCount(String likeText) {
        // TODO Auto-generated method stub
        throw new UnsupportedOperationException("Unimplemented method 'extractLikesCount'");
    }
}